                ...
                <div class="container">
                    ...
                    <div class="row team_row" style="margin-left: 16%">
                        <div class="col-md-10 col-sm-4 team_col">
                            <div class="team_item">
                                <div class="team_body">
                                <form method="post" action="doctor_signup.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row" style="padding-left: 25%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="reg_no" class="form-control" required placeholder="Registration No">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-left: 25%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="degree" class="form-control" required placeholder="Enter Degree">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-left: 25%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="specialized" class="form-control" required placeholder="Specialized">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-left: 25%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="chamber" class="form-control" required placeholder="Enter Chamber">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-left: 25%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label for="Available Day">Start Day</label><br>
                                                    <select name="start_day" class="btn btn-primary" required>
                                                ...
                                                <div class="form-group">
                                                <label for="Available Day">Finish Day</label><br>
                                                    <select name="finish_day" class="btn btn-primary" required>
                                                        <option value="Saturday">Saturday</option>
                                                        <option value="Sunday">Sunday</option>
                                                        <option value="Monday">Monday</option>
                                                        <option value="Tuesday">Tuesday</option>
                                        ...
                                        <div class="row" style="padding-left: 25%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label for="Available Time">Start Time</label>
                                                    <input type="time" name="start_time" class="form-control" required placeholder="Start Time">
                                                </div>
                                                <div class="form-group">
                                                    <label for="Available Time">Finish Time</label>
                                                    <input type="time" name="finish_time" class="form-control" required placeholder="Finish Time">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-left: 25%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" required name="pic" accept="image/*">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-left: 55.8%">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary" required name="save">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                </form>
