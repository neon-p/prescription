        ...
        <div class="team" id="About">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="section_title_container text-center">
                                <h2 class="section_title">Test List</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row team_row" style="margin-left: 16%">
                        <div class="col-md-10 col-sm-4 team_col">
                            <div class="team_item">
                                ...
                                <table  class='table'>
                                    ...
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_array($sql)){
                                            echo '<tr>';
                                                $test_id= $row['test_id'];
                                                echo '<td><h5>'.$row['test_id'].'</h5></td>';
                                                echo '<td><h5>'.$row['test_name'].'</h5></td>';
                                                echo '<td><a class="btn btn-danger" href="delete_test.php?test_id='.$test_id.'">Delete</a></td>';
                                            echo '</tr>';
                                        }
                                    ?>
                                    </tbody>
                                ...
                                <br>
                                <div>
                                    <button type="button" class="btn btn-primary" id="addBtn" data-toggle="modal" data-target="#addModal">New Test</button>
                                </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="addModal" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <form role="form" method="post" action="test_add.php">
                        <div class="form-group">
                            <label for="Medicine Name"><span class="glyphicon glyphicon-user"></span> <h5>Test Name</h5></label>
                            <input type="text" class="form-control" name="test_name" placeholder="Enter Test Name">
                        </div>
                        <button type="submit" class="btn btn-success" name="save">Add Test</button>
                    </form>
                    </div>
                </div>
                </div>
