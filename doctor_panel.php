                                ...
                                <div class="header_content d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <nav class="main_nav_contaner ml-auto">
                                        <ul class="main_nav">
                                            ...
                                            <li><a href="test_list_for_doctor.php">Test</a></li>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="section_title_container text-center">
                                <h2 class="section_title">Doctors Panel</h2>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row"  style="padding-right: 4%">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h2><a href="medicine_list_for_doctor.php">Medicine</a></h2>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h2><a href="patient_list_for_doctor.php">Patient</a></h2>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h2><a href="prescription.php">Prescription</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
