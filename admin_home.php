                    ...
                    <div class="row team_row" style="margin-left: 16%">
                        <div class="col-md-10 col-sm-4 team_col">
                            <div class="team_item">
                                <div class="team_body">
                                    <div class="row">
                                        <div class="col-md-12" style="padding-bottom: 3%;padding-right:5%;">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h2><a href="add_medicine.php">Medicine</a></h2>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h2><a href="doctor_list_for_admin.php">Doctor</a></h2>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h2><a href="add_test.php">Test</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
