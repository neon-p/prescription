		...
		<div class="container">
			...
			<div class="row courses_row">
					...
					<?php
						...
						$string='approved';
						$query ="SELECT * FROM doctor WHERE doctor_status='$string'";
					...
					<div class="col-lg-4 course_col">
						<div class="course">
							<div class="course_image"><img src="<?php echo $image_path.$row['doctor_image'] ?>"></div>
							<div class="course_body">
								<h3 class="course_title"><?php echo '<h4>Dr. '.$row['doctor_name'].'</h4>';?></h3>
								<div class="course_text">

					<?php
								echo 'Specialist on: <h5>'.$row['doctor_specialized'].'</h5>';
								echo 'Degree: <h5>'.$row['doctor_degree'].'</h5>';
								echo 'Available Time: <h5>'.$row['doctor_start_time'].'-'.$row['doctor_finish_time'].'</h5>';
								echo 'Available Day: <h5>'.$row['doctor_start_day'].'-'.$row['doctor_finish_day'].'</h5>';
								echo 'Email: <h5>'.$row['doctor_email'].'</h5>';
					?>
								</div>
							</div>
							<div class="course_footer">
								<div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
									<div class="course_info">
										<span>Chamber</span>
										<?php echo '<h5>'.$row['doctor_chamber'].'</h5>'; ?>
									</div>
								</div>
							</div>
						</div>
